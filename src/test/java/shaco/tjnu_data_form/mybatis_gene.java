...
public class mybatis_gene {

    public static void main(String[] args) {
        //配置数据源
        HikariDataSource dataSource = new HikariDataSource();
        dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/form_system?characterEncoding=utf-8");
        dataSource.setUsername("root");
        dataSource.setPassword("FNb112358*");
...
//        globalConfig.setControllerOverwriteEnable(true);
        ...
        //设置根包
        globalConfig.setBasePackage("shaco.tjnu_data_form");
