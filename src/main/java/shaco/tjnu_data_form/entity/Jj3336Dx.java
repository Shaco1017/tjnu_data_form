...
@AllArgsConstructor
@Table("jj3336_dx")
public class Jj3336Dx implements Serializable {
     ...
     * #分类考试
     */
    private Integer classificationTest;
    ...
    /**
     * 生源类别_中等职业教育_#五年制高职转入
     */
    private Integer sourceCategorySecondaryVocationalEducationFiveYear;
